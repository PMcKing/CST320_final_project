...
namespace Ab3d
{
	namespace OculusWrap
	{
		namespace DemoDX11
		{
			...
			public:
				static Vector3 *ToVector3(Vector4 *vector4);
				...
				static Vector3 *ToVector3(Vector3f *ovrVector3f);
				...
				static Matrix *ToMatrix(Matrix4f *ovrMatrix4f);

				/// <summary>
				/// Converts an ovrQuatf to a SharpDX Quaternion.
				/// </summary>
				static Quaternion *ToQuaternion(Quaternionf *ovrQuatf);
				...
				static TextureSwapChainDesc *CreateTextureSwapChainDescription(Texture2DDescription *texture2DDescription);
				...
				/// </returns>
				static TextureFormat *GetTextureFormat(SharpDX::DXGI::Format *textureFormat);
				...
				static TextureMiscFlags *GetTextureMiscFlags(Texture2DDescription *texture2DDescription, bool allowGenerateMips);
				...
				static TextureBindFlags *GetTextureBindFlags(SharpDX::Direct3D11::BindFlags *bindFlags);
			};
		}
	}
}
...
namespace Ab3d
{
	namespace OculusWrap
	{
		namespace DemoDX11
		{
			...
			Vector3 *SharpDXHelpers::ToVector3(Vector4 *vector4)
			{
				return new Vector3(vector4->X, vector4->Y, vector4->Z);
			}

			Vector3 *SharpDXHelpers::ToVector3(Vector3f *ovrVector3f)
			{
				return new Vector3(ovrVector3f->X, ovrVector3f->Y, ovrVector3f->Z);
			}

			Matrix *SharpDXHelpers::ToMatrix(Matrix4f *ovrMatrix4f)
			{
			...
			Quaternion *SharpDXHelpers::ToQuaternion(Quaternionf *ovrQuatf)
			{
				return new Quaternion(ovrQuatf->X, ovrQuatf->Y, ovrQuatf->Z, ovrQuatf->W);
			}

			TextureSwapChainDesc *SharpDXHelpers::CreateTextureSwapChainDescription(Texture2DDescription *texture2DDescription)
			{
				...
				textureSwapChainDescription->ArraySize = static_cast<int>(texture2DDescription->ArraySize);
				textureSwapChainDescription->Width = static_cast<int>(texture2DDescription->Width);
				textureSwapChainDescription->Height = static_cast<int>(texture2DDescription->Height);
				textureSwapChainDescription->MipLevels = static_cast<int>(texture2DDescription->MipLevels);
				textureSwapChainDescription->SampleCount = static_cast<int>(texture2DDescription->SampleDescription->Count);
			...
			TextureFormat *SharpDXHelpers::GetTextureFormat(SharpDX::DXGI::Format *textureFormat)
			{
				switch (textureFormat)
				{
					...
					case SharpDX::DXGI::Format::B8G8R8X8_UNorm_SRgb:
						return TextureFormat::B8G8R8X8_UNorm_SRgb;
					...
					case SharpDX::DXGI::Format::D32_Float_S8X24_UInt:
						return TextureFormat::D32_Float_S8X24_UInt;
			...
			TextureMiscFlags *SharpDXHelpers::GetTextureMiscFlags(Texture2DDescription *texture2DDescription, bool allowGenerateMips)
			{
			...
			TextureBindFlags *SharpDXHelpers::GetTextureBindFlags(SharpDX::Direct3D11::BindFlags *bindFlags)
			{
